...
class HanumanChalisa extends StatefulWidget {
  ...
  const HanumanChalisa({Key? key,required this.listIndex}) : super(key: key);

  @override
  _HanumanChalisaState createState() => _HanumanChalisaState(listIndex);
}
...
class _HanumanChalisaState extends State<HanumanChalisa> {
  ...
  _HanumanChalisaState(this. listIndex);  //constructor
  ...
  void initState() {
    ...
    // _bannerAd = BannerAd(
    //   adUnitId: AdHelper.bannerAdUnitIdOfHanumanChalisa,
              ...
              children: [
                ...
                Expanded(
                    ...
                    ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:  hanuman_chalisa_hindi.length,
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(hanuman_chalisa_hindi[i] ,
                                      style: GoogleFonts.macondo(fontSize: 26, color: kprimarycolor,height: 1.6,letterSpacing: 1,fontWeight: FontWeight.w400),textAlign: TextAlign.center,),
                                  ),
                                ),
                              ],
                            ),
                ...
                Expanded(
                    ...
                    ListView.builder(
                      physics: const NeverScrollableScrollPhysics(),
                      shrinkWrap: true,
                      itemCount: hanuman_chalisa_english.length,
                      itemBuilder: (context, i) {
                        return Column(
                          children: [
                            Row(
                              children: [
                                Expanded(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text(hanuman_chalisa_english[i] ,
